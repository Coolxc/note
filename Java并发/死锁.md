...
如果锁获取的顺序是相反的那么就会产生死锁，如t1线程先后获取a,b锁而线程二先后获取b,a锁
...
可能是发生了环形死锁。所以，多人转账的死锁发生概率也是一定会发生的。
...
> ##### 避免策略：哲学家就餐的换手方案
>
> > 如在转账案例中，我们可以避免相反的获取顺序。在这里其实获取锁的顺序我们并不关心，那个锁先获得都对结果毫无影响。
> >
> > ```java
> > //在transfer转账函数中修改
...
public class DiningPhilosophers {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < philosophers.length; i++){
            ...
            Object rightChopstick = chopsticks[(i+1) % chopsticks.length]; //右筷子。类似循环队列，最大容量为5
